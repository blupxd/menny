...
const LoginPage = () => {
  return (
    <div className="min-h-screen flex md:flex-row flex-col">
      <div className="shadow-lg shadow-black/50 z-10 bg-transparent flex flex-col py-10 min-h-screen px-4 md:px-24 justify-center w-full md:w-1/2 bg-gradient-to-tr from-purple-800/20 to-cyan-800/20">
